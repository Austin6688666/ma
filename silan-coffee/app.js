...
const I18N_DICTS = {
    zh: {
        ...
        "founder-p1-desc": "用自然之物敬畏脚下土地。从澄迈火山红土的咖啡豆，到海岸线的新鲜食材，让每一次体验都有根可寻。",
        "founder-p2-title": "人文温度",
        "founder-p2-desc": "用善意重塑日常服务。以尊重和专业让每位伙伴与宾客被平等看待，让社会微光在这里汇聚。",
        "founder-p3-title": "绿色生态",
        "founder-p3-desc": "以最低碳的足迹实践海岛环保。从咖啡渣有机肥料循环，到贝壳粗砂环保杯，实现大自然无痕运转。",
    ...
    en: {
        ...
        "founder-p1-desc": "Honor the local land with natural elements. From volcanic basalt coffee beans to coastal fresh ingredients, each experience remains rooted.",
        "founder-p2-title": "Humanistic Warmth",
        "founder-p2-desc": "Reshape daily service with kindness. Treat every co-worker and guest with equal respect and professionalism.",
        "founder-p3-title": "Green Ecology",
        "founder-p3-desc": "Practice island conservation with a minimal carbon footprint. From composting to shell-sand cups, achieving natural cycles.",
